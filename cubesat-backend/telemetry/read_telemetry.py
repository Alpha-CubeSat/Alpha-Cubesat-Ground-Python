...
def compute_normal_report_values(data: dict) -> dict:
    ...
    fixed_data = {
        ...
        'mag_x_value' : map_range(float(data['mag_x_value']), 0, 255, -150, 150),
        'mag_y_value' : map_range(float(data['mag_y_value']), 0, 255, -150, 150),
        'mag_z_value' : map_range(float(data['mag_z_value']), 0, 255, -150, 150),
        'gyro_x_value' : map_range(float(data['gyro_x_value']), 0, 255, -5, 5),
        'gyro_y_value' : map_range(float(data['gyro_y_value']), 0, 255, -5, 5),
        'gyro_z_value' : map_range(float(data['gyro_z_value']), 0, 255, -5, 5),
